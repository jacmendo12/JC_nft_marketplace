...
const sharedList: Toffer[] = [
  {
    ...
    buyerData: [
      ...
      //     "auctionsValue": 1101,   0x67a10b740e9ed805dfb3c85e16af844ca0d16b5e18f712946e448c52eafe2757
...

      {
        ...
        auctionsHash:
          "0x62b03ed6a610eb40e7b26a191e74a03dc34f02f91ad738eb6f26975bba834a99",
        auctionsValue: 2000,
        newAuctionsValue: "3101",
        buyerAddress: "0x2B4BB6B8512Ae5363F03DB53Fd20CC7C464168C9",
        status: "Pending",
        AproveTransactionHash:
          "0x7258011242447d452000e9780713912f28468b20507813ba3bf05b0d2fe7e746",
      },
    ],
